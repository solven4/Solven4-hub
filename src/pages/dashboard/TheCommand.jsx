    ...
    <motion.button
      ...
      <div style={{ display:'flex', alignItems:'center', gap:'12px', marginBottom:'12px' }}>
        ...
        <div style={{ minWidth:0 }}>
          ...
          <div style={{ fontFamily:"'Rajdhani',sans-serif", fontSize:'10px', letterSpacing:'0.14em', color:statusColor, textTransform:'uppercase', marginTop:'2px' }}>{door.status}</div>
        </div>
      </div>
              ...
              {SYSTEM_HEALTH.map(s => (
                <div key={s.label} style={{ display:'flex', alignItems:'center', gap:'12px', padding:'7px 0', borderBottom:'1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <div style={{ flex:1, minWidth:0 }}>
                    ...
                    <div className="s4-num" style={{ color:s.color, fontSize:'11px', fontWeight:700, fontFamily:"'Rajdhani',sans-serif", letterSpacing:'0.06em' }}>{s.pct}%</div>
                  </div>
                </div>
              ))}
            </div>
