...
// Use configured env in real deployments; fall back to inert placeholders so the
// app can still boot (e.g. preview environments) instead of throwing at import time.
